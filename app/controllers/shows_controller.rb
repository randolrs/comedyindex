class ShowsController < ApplicationController
  ...
  private
    ...
    def show_params
      params.require(:show).permit(:name, :market_id, :venue_id, :website_url, :about, :address_line_1, :address_line_2, :city, :state_province, :country, :image, :start_time, :venue_name, show_occurences_attributes:[:start_time])
    end
end
